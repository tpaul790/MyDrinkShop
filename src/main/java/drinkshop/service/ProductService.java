...
public class ProductService {
    ...
    public void addProduct(Product p) {
        productValidator.validate(p); // validam produsul inainte de a-l trimite spre repository
        productRepo.save(p);
    }
    ...
    public void updateProduct(int id, String name, double price, CategorieBautura categorie, TipBautura tip) {
        ...
        productValidator.validate(updated); // validam produsul inainte de a-l trimite spre repository
